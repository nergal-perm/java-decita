...
## [0.6.0](https://github.com/nergal-perm/java-decita/compare/v0.5.2...v0.6.0) (2024-05-23)


### ⚠ BREAKING CHANGES

* Maven multi-module affects build and deploy processes
* **commands:** CommandsFacade's constructor now requires the StoredState instead of DecisionFacade

* combined decita with logic-checker ([5819906](https://github.com/nergal-perm/java-decita/commit/581990681430260fd6e520f4182139d6d456ded5)), closes [#117](https://github.com/nergal-perm/java-decita/issues/117)
* **commands:** made CommandsFacade accept StoredState ([1341920](https://github.com/nergal-perm/java-decita/commit/1341920485325cb12760e894ba19299e199a51b7)), closes [#114](https://github.com/nergal-perm/java-decita/issues/114)
